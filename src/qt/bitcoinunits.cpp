...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case KKC:
        return QString("kabberry");
    case mKKC:
        return QString("mkabberry");
    case uKKC:
        return QString::fromUtf8("ukabberry");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool issKKC)
{
    QString z = "";
    if(issKKC) z = "z";
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case KKC:
            return z + QString("KKC");
        case mKKC:
            return z + QString("mKKC");
        case uKKC:
            return z + QString::fromUtf8("μKKC");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case KKC:
            return z + QString("tKKC");
        case mKKC:
            return z + QString("mtKKC");
        case uKKC:
            return z + QString::fromUtf8("μtKKC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool issKKC)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, issKKC);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool issKKC)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, issKKC));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
