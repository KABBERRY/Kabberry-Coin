                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Kabberry") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Kabberry address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kabberry: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Kabberry"), this);
    aboutAction->setStatusTip(tr("Show information about Kabberry"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Kabberry"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Kabberry addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Kabberry addresses"));
    ...
    openAction->setStatusTip(tr("Open a Kabberry: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Kabberry help message to get a list with possible Kabberry command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Kabberry client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Kabberry network", "", count));
}
...
{
    QString strTitle = tr("Kabberry"); // default title
