...
#include "qt/kabberry/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/kabberry/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(KabberryGUI* _window, QWidget *parent) :
