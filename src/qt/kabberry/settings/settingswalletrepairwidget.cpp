...
#include "qt/kabberry/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/kabberry/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(KabberryGUI* _window, QWidget *parent) :
