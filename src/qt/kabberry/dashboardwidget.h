...
#include "qt/kabberry/furabstractlistitemdelegate.h"
...
#include "config/kabberry-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalKKC = 0;
    qint64 totalsKKC = 0;
    QList<qreal> valuesKKC;
    QList<qreal> valuessKKC;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(KabberryGUI* _window);
    ~DashboardWidget();
