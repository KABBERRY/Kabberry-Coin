...
#include "qt/kabberry/forms/ui_coldstakingwidget.h"
#include "qt/kabberry/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/kabberry/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(KabberryGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your KKCs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept KKC delegation / Delegate KKC"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select KKC outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 KKC" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
