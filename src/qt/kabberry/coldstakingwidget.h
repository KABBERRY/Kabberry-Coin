...
#include "qt/kabberry/sendmultirow.h"
#include "qt/kabberry/coldstakingmodel.h"
#include "qt/kabberry/contactsdropdown.h"
#include "qt/kabberry/addressholder.h"
...
public:
    explicit ColdStakingWidget(KabberryGUI* parent);
    ~ColdStakingWidget();
