...
#ifndef Kabberry_CORE_NEW_GUI_KabberryGUI_H
#define Kabberry_CORE_NEW_GUI_KabberryGUI_H
...
#include "qt/kabberry/navmenuwidget.h"
#include "qt/kabberry/topbar.h"
#include "qt/kabberry/dashboardwidget.h"
#include "qt/kabberry/send.h"
#include "qt/kabberry/receivewidget.h"
#include "qt/kabberry/addresseswidget.h"
#include "qt/kabberry/privacywidget.h"
#include "qt/kabberry/coldstakingwidget.h"
#include "qt/kabberry/masternodeswidget.h"
#include "qt/kabberry/snackbar.h"
#include "qt/kabberry/settings/settingswidget.h"
...
/**
  Kabberry GUI main class. This class represents the main window of the Kabberry UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KabberryGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KabberryGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~KabberryGUI();
...
#endif //Kabberry_CORE_NEW_GUI_KabberryGUI_H
