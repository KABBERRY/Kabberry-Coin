...
=======
 * The Secp256k1 curve has an enprimestonerphism, where lambda * (x, y) = (beta * x, y), where
>>>>>>> Stashed changes
...
=======
 * when decomposing the scalar for an enprimestonerphism-based point multiplication.
>>>>>>> Stashed changes
 *
