...
#else
/**
 * The Secp256k1 curve has an enkabberryrphism, where lambda * (x, y) = (beta * x, y), where
 ...
 * when decomposing the scalar for an enkabberryrphism-based point multiplication.
 *
