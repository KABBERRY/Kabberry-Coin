 ...
 * Kabberry system. There are three: the main network on which people trade goods
...
public:
    ...
    int KabberryBadBlockTime() const { return nKabberryBadBlockTime; }
    int KabberryBadBlocknBits() const { return nKabberryBadBlocknBits; }
