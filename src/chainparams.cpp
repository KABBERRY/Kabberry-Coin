...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("041f5ae176fb57fb89375f57e8e3a701a4f516235327580da9a7c0130d2a7b8c5accc644cd2e9bf3104cfcdb861ce2e336ff31b81473620568e886c7c437ddf954") << OP_CHECKSIG;
...
public:
    CMainParams()
    {
        ...
        consensus.height_start_BIP65 = 573000; // 82629b7a9978f5c7ea3f70a12db92633a7d2e436711500db28b97efd48b1e527
        ...
        assert(consensus.hashGenesisBlock == uint256("0x00000fe79c10addf7e023042d3ef98ce24d36262ae7c05c46c085c1ee14434d1"));
        ...
        nLastPOWBlock = 13440;
        nKabberryBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nKabberryBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        nModifierUpdateBlock = 570000;
        nZerocoinStartHeight = 260000;
        nZerocoinStartTime = 1567339200; // October 17, 2017 4:30:00 AM
        ...
        nEnforceNewSporkKey = 1575115200; //!> Sporks signed after Monday, August 26, 2019 11:00:00 PM GMT must use the new spork key
        nRejectOldSporkKey = 1577707200; //!> Fully reject old spork key after Thursday, September 26, 2019 11:00:00 PM GMT
        ...
        vSeeds.push_back(CDNSSeedData("seeder.kabberry.xyz", "seeder.kabberry.xyz"));
        vSeeds.push_back(CDNSSeedData("seeder2.kabberry.xyz", "seeder2.kabberry.xyz"));
        vSeeds.push_back(CDNSSeedData("seeder3.kabberry.xyz", "seeder3.kabberry.xyz"));
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a skkc to be stakable
...
public:
    CTestNetParams()
    {
       ...
       // assert(genesis.hashMerkleRoot == uint256("0x1b2ef6e2f28be914103a277377ae7729dcd125dfeb8bf97bd5964ba72b6dc39b"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet kabberry addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet kabberry script addresses start with '8' or '9'
