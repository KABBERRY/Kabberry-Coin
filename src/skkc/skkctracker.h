...
public:
    CsKKCTracker(std::string strWalletFile);
    ~CsKKCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CsKKCWallet* sKKCWallet = NULL);
