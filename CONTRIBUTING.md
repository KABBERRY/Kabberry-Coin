...
=======
Contributing to PrimeStone
============================

The PrimeStone project operates an open contributor model where anyone is
>>>>>>> Stashed changes
...
=======
  - *Qt* for changes to primestone-qt
>>>>>>> Stashed changes
...
=======
  - *Tests* for changes to the primestone unit tests or QA tests
>>>>>>> Stashed changes
...
=======
The following applies to code changes to the PrimeStone project, and is not to be
confused with overall PrimeStone Network Protocol consensus changes.

Whether a pull request is merged into PrimeStone rests with the project merge
>>>>>>> Stashed changes
...
Patches that change PrimeStone consensus rules are considerably more involved than
>>>>>>> Stashed changes
...
=======
Where a patch set proposes to change the PrimeStone consensus, it must have been
...
=======
The project leader is the release manager for each PrimeStone release.
>>>>>>> Stashed changes
