Contributing to Kabberry
============================

The Kabberry project operates an open contributor model where anyone is
...
The following applies to code changes to the Kabberry project, and is not to be
confused with overall Kabberry Network Protocol consensus changes.

Whether a pull request is merged into Kabberry rests with the project merge
...
Patches that change Kabberry consensus rules are considerably more involved than
...
Where a patch set proposes to change the Kabberry consensus, it must have been
...
The project leader is the release manager for each Kabberry release.
